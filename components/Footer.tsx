          ...
          <div className={`grid grid-cols-1 gap-8 ${market.id === 'national' ? 'md:grid-cols-3' : 'md:grid-cols-4'}`}>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {(market.id === 'chicago' ? chicagoSocialLinks : socialLinks).map((link) => (
                  <a
                    key={link.label}
                    href={link.href}
                    target="_blank"
...
/** Chicago runs its own social accounts, separate from the national/Texas ones. */
const chicagoSocialLinks = [
  {
    href: 'https://www.instagram.com/roboboothchicago/',
    label: 'Instagram',
    icon: instagramIcon,
  },
  {
    href: 'https://www.facebook.com/people/RoboBooth-Chicago/61575461138187/',
    label: 'Facebook',
    icon: facebookIcon,
  },
]
